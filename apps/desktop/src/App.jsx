...
function App() {
  ...
  const checkApi = async () => {
    ...
    const result = await checkCGPHealth();
    setApiStatus(result);
  };
  ...
  const connected = apiStatus.state === "online";
    ...
    <div className="app-shell">
          ...
          {modules.map((item) => (
            ...
            >
              ...
              {item.state === "prototype" && (
                <small className="nav-badge">LAB</small>
              )}
            </button>
          ))}
        </nav>
      ...
      <main className="main-area">
        <header className="topbar">
          <div>
            <span className="eyebrow">CGP PLATFORM</span>
          ...
          <div className="top-actions">
            ...
            <button type="button" className="profile-button">
              <span className="profile-avatar">EX</span>
          ...
          <div className="content">
            <section className="hero">
              <div className="hero-copy">
                ...
                <h2>Control your competitive ecosystem.</h2>
              ...
              <div className="connection-panel">
                <div className="connection-header">
                  ...
                  <span className="connection-badge">REMOTE</span>
                </div>
                  ...
                  <div>
                    ...
                    <span>
                      {connected
                        ...
                        : apiStatus.error || "Checking CGP API"}
                    </span>
                  </div>
                </div>
        ...
        {!["home", "inspector"].includes(active) && (
          <div className="content">
            <section className="module-workspace">
              <span className="section-tag">MODULE WORKSPACE</span>

              <h2>{activeModule.label}</h2>

              <p>
                This workspace is ready for its first real CGP
                integration. Capabilities will be connected here

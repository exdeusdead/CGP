...
class PlatformBootstrapper {
    ...
    async initialize() {
        ...
        for (const engine of this.order) {
            ...
            try {
                ...
                console.error(`Initialization failed: ${engine.name}`);
    ...
    async start() {
        ...
        for (const engine of this.order) {
            ...
            try {
                ...
                console.error(`Start failed: ${engine.name}`);
                console.error(err.message);
    ...
    getEngine(name) {
        return this.context.engines.get(name);
    }
    ...
    getServiceNames() {
        return [...this.context.services.keys()];
    }
